 ...
 */
static struct ess_command ess_i08m[] = {	/* input 8 bit mono */ {0xb7, 0x51}, {0xb7, 0xd0}, {-1, 0}
};
static struct ess_command ess_i16m[] = {	/* input 16 bit mono */ {0xb7, 0x71}, {0xb7, 0xf4}, {-1, 0}
};
static struct ess_command ess_i08s[] = {	/* input 8 bit stereo */ {0xb7, 0x51}, {0xb7, 0x98}, {-1, 0}
};
static struct ess_command ess_i16s[] = {	/* input 16 bit stereo */ {0xb7, 0x71}, {0xb7, 0xbc}, {-1, 0}
};
 ...
 */
static struct ess_command ess_o08m[] = {	/* output 8 bit mono */ {0xb6, 0x80}, {0xb7, 0x51}, {0xb7, 0xd0}, {-1, 0}
};
static struct ess_command ess_o16m[] = {	/* output 16 bit mono */ {0xb6, 0x00}, {0xb7, 0x71}, {0xb7, 0xf4}, {-1, 0}
};
static struct ess_command ess_o08s[] = {	/* output 8 bit stereo */ {0xb6, 0x80}, {0xb7, 0x51}, {0xb7, 0x98}, {-1, 0}
};
static struct ess_command ess_o16s[] = {	/* output 16 bit stereo */ {0xb6, 0x00}, {0xb7, 0x71}, {0xb7, 0xbc}, {-1, 0}
};
...
static int ess_common_set_irq_hw (sb_devc * devc)
{
    ...
    if ((irq_bits = ess_irq_bits (devc->irq)) == -1) {
        return 0;
    }
