                         ...
                         unsigned long arg)
{
    ...
    case DSP56K_DEV_56001:
        ...
        case DSP56K_HOST_FLAGS: {
            ...
            status = 0;
            if (dsp56k_host_interface.icr & DSP56K_ICR_HF0) {
                status |= 0x1;
            }
            if (dsp56k_host_interface.icr & DSP56K_ICR_HF1) {
                status |= 0x2;
            }
            if (dsp56k_host_interface.isr & DSP56K_ISR_HF2) {
                status |= 0x4;
            }
            if (dsp56k_host_interface.isr & DSP56K_ISR_HF3) {
                status |= 0x8;
            }
            mutex_unlock(&dsp56k_mutex);
