                             ...
                             struct usb_serial_port *port, struct ktermios *old_termios)
{
    ...
    if (baud != tty_termios_baud_rate(old_termios)) {
        ...
        case 0:
            digi_set_modem_signals(port, 0, 1);
            break;
        case 50:
            arg = DIGI_BAUD_50;
            break;
        ...
        case 57600:
            ...
            break;
        case 115200:
            arg = DIGI_BAUD_115200;
            break;
        case 230400:
            arg = DIGI_BAUD_230400;
            break;
        case 460800:
            arg = DIGI_BAUD_460800;
            break;
        default:
            arg = DIGI_BAUD_9600;
            baud = 9600;
    ...
    if ((cflag&CSIZE) != (old_cflag&CSIZE)) {
        ...
        switch (cflag&CSIZE) {
        case CS5:
            arg = DIGI_WORD_SIZE_5;
            break;
        case CS6:
            arg = DIGI_WORD_SIZE_6;
            break;
        case CS7:
            arg = DIGI_WORD_SIZE_7;
            break;
        case CS8:
            arg = DIGI_WORD_SIZE_8;
            break;
        default:
            dev_dbg(dev,
