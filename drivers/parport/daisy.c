...
static int cpp_daisy(struct parport *port, int cmd)
{
    ...
    parport_write_data(port, 0xaa);
    udelay(2);
    parport_write_data(port, 0x55);
    udelay(2);
    parport_write_data(port, 0x00);
    udelay(2);
    ...
    parport_write_data(port, 0x78);
    udelay(2);
    parport_write_data(port, cmd);
    udelay(2);
...
static int cpp_mux(struct parport *port, int cmd)
{
    ...
    parport_write_data(port, 0x55);
    udelay(2);
    parport_write_data(port, 0xf0);
    udelay(2);
    parport_write_data(port, 0x0f);
    udelay(2);
    parport_write_data(port, 0x52);
    udelay(2);
    parport_write_data(port, 0xad);
    udelay(2);
    parport_write_data(port, cmd);
    udelay(2);
