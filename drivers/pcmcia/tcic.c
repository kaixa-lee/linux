...
static int tcic_set_socket(struct pcmcia_socket *sock, socket_state_t *state)
{
    ...
    if (state->Vcc == 50) {
        ...
        case 0:
            ...
            break;
        case 50:
            reg |= TCIC_PWR_VCC(psock);
            break;
        case 120:
            reg |= TCIC_PWR_VPP(psock);
            break;
        default:
            return -EINVAL;
        }
