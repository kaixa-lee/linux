...
static int pxafb_var_to_bpp(struct fb_var_screeninfo *var)
{
    ...
    case 24:
        ...
        case 18:
            bpp = 6;
            break; /* 18-bits/pixel packed */
        case 19:
            bpp = 8;
            break; /* 19-bits/pixel packed */
        case 24:
            bpp = 9;
            break;
        }
    ...
    case 32:
        ...
        case 18:
            bpp = 5;
            break; /* 18-bits/pixel unpacked */
        case 19:
            bpp = 7;
            break; /* 19-bits/pixel unpacked */
        case 25:
            bpp = 10;
            break;
        }
...
static uint32_t pxafb_var_to_lccr3(struct fb_var_screeninfo *var)
{
    ...
    switch (var_to_depth(var)) {
    case 16:
        lccr3 |= var->transp.length ? LCCR3_PDFOR_3 : 0;
        break;
    case 18:
        lccr3 |= LCCR3_PDFOR_3;
        break;
    case 24:
        lccr3 |= var->transp.length ? LCCR3_PDFOR_2 : LCCR3_PDFOR_3;
        break;
    case 19:
    case 25:
        lccr3 |= LCCR3_PDFOR_0;
...
static void pxafb_set_pixfmt(struct fb_var_screeninfo *var, int depth)
{
    ...
    case 16:
        ...
        SET_PIXFMT(var, 5, 6, 5, 0);
        break;	/* RGB565 */
    case 18:
        SET_PIXFMT(var, 6, 6, 6, 0);
        break;	/* RGB666 */
    case 19:
        SET_PIXFMT(var, 6, 6, 6, 1);
        break;	/* RGBT666 */
    case 24:
        var->transp.length ?
        SET_PIXFMT(var, 8, 8, 7, 1) :		/* RGBT887 */
        SET_PIXFMT(var, 8, 8, 8, 0);
        break;	/* RGB888 */
    case 25:
        SET_PIXFMT(var, 8, 8, 8, 1);
        break;	/* RGBT888 */
    }
}
...
static void overlay2fb_setup(struct pxafb_layer *ofb)
{
    ...
    if (pfor == OVERLAY_FORMAT_RGB || pfor == OVERLAY_FORMAT_YUV444_PACKED) {
        ...
        switch (pfor) {
        case OVERLAY_FORMAT_YUV444_PLANAR:
            div = 1;
            break;
        case OVERLAY_FORMAT_YUV422_PLANAR:
            div = 2;
            break;
        case OVERLAY_FORMAT_YUV420_PLANAR:
            div = 4;
            break;
        }
                               ...
                               struct fb_info *info)
{
    ...
    case OVERLAY_FORMAT_RGB:
        ...
        pxafb_set_pixfmt(var, var_to_depth(var));
        break;
    case OVERLAY_FORMAT_YUV444_PACKED:
        bpp = 24;
        break;
    case OVERLAY_FORMAT_YUV444_PLANAR:
        bpp = 8;
...
static int parse_opt_mode(struct device *dev, const char *this_opt)
{
    ...
    if (res_specified) {
        ...
        inf->modes[0].xres = xres;
        inf->modes[0].yres = yres;
    }
    if (bpp_specified)
        switch (bpp) {
        case 1:
