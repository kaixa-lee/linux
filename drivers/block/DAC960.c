    ...
    */
    ...
    case DAC960_V1_P_PD_PU:
        if (Enquiry2->SCSICapability.BusSpeed == DAC960_V1_Ultra) {
            ...
            strcpy(Controller->ModelName, "DAC960PD");
        }
        break;
    case DAC960_V1_PL:
                                       ...
                                       unsigned char *SerialNumber)
{
    ...
    if (InquiryStandardData->PeripheralDeviceType == 0x1F) {
        return;
    }
                                     ...
                                     unsigned char Parameter1)
{
    ...
    case 0x00:
        ...
        break;
    case 0x08:
        if (Controller->DriveSpinUpMessageDisplayed) {
            break;
        }
                                  ...
                                  DAC960_V2_Event_T *Event)
{
    ...
    case 'S':
        ...
        break;
    case 'E':
        if (Controller->SuppressEnclosureMessages) {
            break;
        }
...
static void DAC960_MonitoringTimerFunction(unsigned long TimerData)
{
    ...
    if (Controller->FirmwareType == DAC960_V1_Controller) {
        ...
        if (Command != NULL) {
            ...
            Controller->MonitoringCommandDeferred = true;
        }
        spin_unlock_irqrestore(&Controller->queue_lock, flags);
    } else {
        DAC960_V2_ControllerInfo_T *ControllerInfo =
        ...
        size_t Count, loff_t *pos)
{
    ...
    int Length;
    if (Count > sizeof(CommandBuffer)-1) {
        return -EINVAL;
    }
    if (copy_from_user(CommandBuffer, Buffer, Count)) {
        return -EFAULT;
    }
