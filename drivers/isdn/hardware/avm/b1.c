...
void b1_parse_version(avmctrl_info *cinfo)
{
    ...
    switch (flag) {
    case 0:
        if (cinfo->version[VER_CARDTYPE]) {
            strcpy(cinfo->cardname, cinfo->version[VER_CARDTYPE]);
        } else {
            strcpy(cinfo->cardname, "B1");
        }
        break;
    case 3:
        strcpy(cinfo->cardname, "PCMCIA B");
        break;
    case 4:
        strcpy(cinfo->cardname, "PCMCIA M1");
        break;
    case 5:
        strcpy(cinfo->cardname, "PCMCIA M2");
        break;
    case 6:
        strcpy(cinfo->cardname, "B1 V3.0");
        break;
    case 7:
        strcpy(cinfo->cardname, "B1 PCI");
        break;
    default:
        sprintf(cinfo->cardname, "AVM?%u", (unsigned int)flag);
        break;
    }
