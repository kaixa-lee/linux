...
#define FREQ2  4000000 /* 4 MHz Quartz oscillator in the stick? */
    ...
    if      (freq < 290000000) {
        reg05 = 0x14;    /* 290 MHz */
    } else if (freq < 610000000) {
        reg05 = 0x34;    /* 610 MHz */
    } else if (freq < 802000000) {
        reg05 = 0x54;    /* 802 MHz */
    } else {
        reg05 = 0x74;
    }
    ...
    if      (mod1 < 1*FREQ2) {
        rd[7].val = 0x09;    /*  +0 MHz */
    } else if (mod1 < 2*FREQ2) {
        rd[7].val = 0x08;    /*  +4 MHz */
    } else if (mod1 < 3*FREQ2) {
        rd[7].val = 0x0f;    /*  +8 MHz */
    } else if (mod1 < 4*FREQ2) {
        rd[7].val = 0x0e;    /* +12 MHz */
    } else if (mod1 < 5*FREQ2) {
        rd[7].val = 0x0d;    /* +16 MHz */
    } else if (mod1 < 6*FREQ2) {
        rd[7].val = 0x0c;    /* +20 MHz */
    } else if (mod1 < 7*FREQ2) {
        rd[7].val = 0x0b;    /* +24 MHz */
    } else {
        rd[7].val = 0x0a;    /* +28 MHz */
    }
    ...
    /* 22 */
    if      (freq < 450000000) {
        rd[15].val = 0xd0;    /* 450 MHz */
    } else if (freq < 482000000) {
        rd[15].val = 0xd1;    /* 482 MHz */
    } else if (freq < 514000000) {
        rd[15].val = 0xd4;    /* 514 MHz */
    } else if (freq < 546000000) {
        rd[15].val = 0xd7;    /* 546 MHz */
    } else if (freq < 610000000) {
        rd[15].val = 0xda;    /* 610 MHz */
    } else {
        rd[15].val = 0xd0;
    }
