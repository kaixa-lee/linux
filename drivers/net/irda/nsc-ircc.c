...
static int nsc_ircc_init_108(nsc_chip_t *chip, chipio_t *info)
{
    ...
    case 0x2f8:
        ...
        break;
    default:
        net_err_ratelimited("%s(), invalid base_address\n", __func__);
    }
    ...
    case 15:
        ...
        break;
    default:
        net_err_ratelimited("%s(), invalid irq\n", __func__);
    }
    ...
    case 3:
        ...
        break;
    default:
        net_err_ratelimited("%s(), invalid dma\n", __func__);
    }
...
static __u8 nsc_ircc_change_speed(struct nsc_ircc_cb *self, __u32 speed)
{
    ...
    switch (speed) {
    case 9600:
        outb(0x0c, iobase+BGDL);
        break;
    case 19200:
        outb(0x06, iobase+BGDL);
        break;
    case 38400:
        outb(0x03, iobase+BGDL);
        break;
    case 57600:
        outb(0x02, iobase+BGDL);
        break;
    case 115200:
        outb(0x01, iobase+BGDL);
        break;
    case 576000:
        switch_bank(iobase, BANK5);
