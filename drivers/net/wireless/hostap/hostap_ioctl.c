        ...
        void *wrqu, char *extra)
{
    ...
    case PRISM2_PARAM_HOSTSCAN: {
        ...
        switch (value) {
        case 1:
            rate = HFA384X_RATES_1MBPS;
            break;
        case 2:
            rate = HFA384X_RATES_2MBPS;
            break;
        case 3:
            rate = HFA384X_RATES_5MBPS;
            break;
        case 4:
            rate = HFA384X_RATES_11MBPS;
            break;
        default:
            rate = HFA384X_RATES_1MBPS;
            break;
...
int hostap_ioctl(struct net_device *dev, struct ifreq *ifr, int cmd)
{
    ...
    case PRISM2_IOCTL_WDS_ADD:
        if (!capable(CAP_NET_ADMIN)) {
            ...
            ret = prism2_wds_add(local, wrq->u.ap_addr.sa_data, 1);
        }
        break;
    ...
    case PRISM2_IOCTL_WDS_DEL:
        if (!capable(CAP_NET_ADMIN)) {
            ...
            ret = prism2_wds_del(local, wrq->u.ap_addr.sa_data, 1, 0);
        }
        break;
