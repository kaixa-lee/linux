                              ...
                              unsigned long **bit, int *max)
{
    ...
    case HID_UP_TIVOVENDOR:
        ...
        /* TiVo button */
        case 0x3d:
            tivo_map_key_clear(KEY_MEDIA);
            break;
        /* Live TV */
        case 0x3e:
            tivo_map_key_clear(KEY_TV);
            break;
        /* Red thumbs down */
        case 0x41:
            tivo_map_key_clear(KEY_KPMINUS);
            break;
        /* Green thumbs up */
        case 0x42:
            tivo_map_key_clear(KEY_KPPLUS);
            break;
        default:
            return 0;
        }
    ...
    case HID_UP_CONSUMER:
        ...
        case 0x083:
            tivo_map_key_clear(KEY_ENTER);
            break;
        /* Info (default mapping: KEY_PROPS) */
        case 0x209:
            tivo_map_key_clear(KEY_INFO);
            break;
        default:
            return 0;
        }
