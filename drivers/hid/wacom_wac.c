...
static const struct wacom_features wacom_features_0x59 = { /* Pen */ "Wacom DTH2242", 95640, 54060, 2047, 63,
    DTK, WACOM_INTUOS3_RES, WACOM_INTUOS3_RES,
    WACOM_CINTIQ_OFFSET, WACOM_CINTIQ_OFFSET,
    .oVid = USB_VENDOR_ID_WACOM, .oPid = 0x5D
};
static const struct wacom_features wacom_features_0x5D = { /* Touch */ "Wacom DTH2242",       .type = WACOM_24HDT,
