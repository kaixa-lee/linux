...
static unsigned short keymap_kip1000(int scancode)
{
    ...
    case 0x82:
        return KEY_NUMERIC_0;		/*   0          */
    case 0x14:
        return KEY_NUMERIC_1;		/*   1          */
    case 0x12:
        return KEY_NUMERIC_2;		/*   2          */
    case 0x11:
        return KEY_NUMERIC_3;		/*   3          */
    case 0x24:
        return KEY_NUMERIC_4;		/*   4          */
    case 0x22:
        return KEY_NUMERIC_5;		/*   5          */
    case 0x21:
        return KEY_NUMERIC_6;		/*   6          */
    case 0x44:
        return KEY_NUMERIC_7;		/*   7          */
    case 0x42:
        return KEY_NUMERIC_8;		/*   8          */
    case 0x41:
        return KEY_NUMERIC_9;		/*   9          */
    case 0x81:
...
static unsigned short keymap_gtalk(int scancode)
{
    ...
    case 0x84:
        return KEY_NUMERIC_STAR;	/* * */
    case 0x18:
        return KEY_ENTER;		/* Talk (green handset) */
    case 0x28:
        return KEY_ESC;		/* End (red handset) */
    case 0x48:
        return KEY_UP;		/* Menu up (rocker switch) */
    case 0x88:
        return KEY_DOWN;		/* Menu down (rocker switch) */
    default:
        return special_keymap(scancode);
    }
}
