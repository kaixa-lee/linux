...
static void via_set_speed(ide_hwif_t *hwif, u8 dn, struct ide_timing *timing)
{
    ...
    case ATA_UDMA2:
        t = timing->udma ? (0xe0 | (clamp_val(timing->udma, 2, 5) - 2)) : 0x03;
        break;
    case ATA_UDMA4:
        t = timing->udma ? (0xe8 | (clamp_val(timing->udma, 2, 9) - 2)) : 0x0f;
        break;
    case ATA_UDMA5:
        t = timing->udma ? (0xe0 | (clamp_val(timing->udma, 2, 9) - 2)) : 0x07;
        break;
    case ATA_UDMA6:
        t = timing->udma ? (0xe0 | (clamp_val(timing->udma, 2, 9) - 2)) : 0x07;
        break;
