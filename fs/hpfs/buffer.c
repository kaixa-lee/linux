                        ...
                        int ahead)
{
    ...
    if (!(qbh->bh[0] = sb_bread(s, secno + 0))) {
        goto bail0;
    }
    if (!(qbh->bh[1] = sb_bread(s, secno + 1))) {
        goto bail1;
    }
    if (!(qbh->bh[2] = sb_bread(s, secno + 2))) {
        goto bail2;
    }
    if (!(qbh->bh[3] = sb_bread(s, secno + 3))) {
        goto bail3;
    }
                        ...
                        struct quad_buffer_head *qbh)
{
    ...
    if (!hpfs_get_sector(s, secno + 0, &qbh->bh[0])) {
        goto bail0;
    }
    if (!hpfs_get_sector(s, secno + 1, &qbh->bh[1])) {
        goto bail1;
    }
    if (!hpfs_get_sector(s, secno + 2, &qbh->bh[2])) {
        goto bail2;
    }
    if (!hpfs_get_sector(s, secno + 3, &qbh->bh[3])) {
        goto bail3;
    }
