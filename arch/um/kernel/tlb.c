                                   ...
                                   struct host_vm_change *hvc)
{
    ...
    do {
        ...
        if (!pmd_present(*pmd)) {
            ...
            ret = update_pte_range(pmd, addr, next, hvc);
        }
                                   ...
                                   struct host_vm_change *hvc)
{
    ...
    do {
        ...
        if (!pud_present(*pud)) {
            ...
            ret = update_pmd_range(pud, addr, next, hvc);
        }
                      ...
                      unsigned long end_addr, int force)
{
    ...
    do {
        ...
        if (!pgd_present(*pgd)) {
            ...
            ret = update_pud_range(pgd, addr, next, &hvc);
        }
...
void flush_tlb_page(struct vm_area_struct *vma, unsigned long address)
{
    ...
    if (pte_newpage(*pte)) {
        if (pte_present(*pte)) {
            ...
            err = unmap(mm_id, address, PAGE_SIZE, 1, &flush);
        }
    } else if (pte_newprot(*pte)) {
