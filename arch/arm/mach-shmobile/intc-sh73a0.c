...
static struct intc_prio_reg intcs_prio_registers[] = {
    ...
    {
        0xffd20014, 0, 16, 4, /* IPRFS */ {
            KEYSC_KEY, RTDMAC_1,
            CMT2, CMT0
        }
    },
    {
        0xffd20018, 0, 16, 4, /* IPRGS */ {
            TMU0_TUNI00, TMU0_TUNI01,
            TMU0_TUNI02, TSIF1
        }
    },
